...
public class SignUp implements KvmSerializable {
    ...
    public static Class<SignUp> UserSignUp= SignUp.class;

    private String dist_code,Dist_name,block_code,block_nm,address,name,fname,mobile,password,confirm_password,EntryBy;
